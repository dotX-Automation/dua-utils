...
namespace DynamicSystems
{
  ...
  protected:
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL init_parse(const InitParams<T>& initParams);
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL setup_parse(const SetupParams<T>& setupParams);
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL setup_default();
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL deinit();
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL state_validator(State<T> &state);
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL input_validator(const State<T> &state, MatrixX<T> &input);
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL dynamic_map(const State<T> &state, const MatrixX<T> &input, State<T> &next);
    virtual void DYNAMIC_SYSTEMS_BASE_LOCAL output_map(const State<T> &state, const MatrixX<T> &input, MatrixX<T> &output);
